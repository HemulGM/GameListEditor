...
resourcestring
  ...
  Rst_Text = 'GameList Editor is a tool to manage your Gamelist.xml' + sLineBreak +
  ...
  Rst_ServerError9 = 'Unknown error';
...
const
  ...
  Cst_DefaultPicsFolderPath = 'Resources' + PathDelim + 'DefaultPictures';
  Cst_DefaultImageNameSuffix = '-default.png';
  Cst_DefaultImageName = 'default.png';
  Cst_LogoPicsFolder = 'Resources' + PathDelim + 'SystemsLogos';
  Cst_IniFilePath = 'Resources' + PathDelim + 'Settings.ini';
  Cst_ResourcesFolder = 'Resources';
  Cst_TxtExtension = '.txt';
  //
  Cst_SystemImagesPath = 'media' + PathDelim + 'images';
  Cst_SystemVideosPath = 'media' + PathDelim + 'videos';
  Cst_SystemBoxesPath = 'media' + PathDelim + 'boxes';
  Cst_SystemManualsPath = 'media' + PathDelim + 'manuals';
  Cst_SystemMapsPath = 'media' + PathDelim + 'maps';
  Cst_SystemTipsAndTricksPath = 'media' + PathDelim + 'tipsandtricks';
  Cst_SystemWheelsPath = 'media' + PathDelim + 'wheels';
  // ini
