...
uses
  ...
  GLE.Help in 'GLE.Help.pas' {Frm_Help},
  GLE.MoreInfos in 'GLE.MoreInfos.pas' {FormMorInfos},
  GLE.AdvNameEditor in 'GLE.AdvNameEditor.pas' {FormAdvNameEditor},
  GLE.ConfigureNetwork in 'GLE.ConfigureNetwork.pas' {Frm_Network},
  GLE.ConfigureSSH in 'GLE.ConfigureSSH.pas' {Frm_ConfigureSSH},
  GLE.DownloadThread in 'GLE.DownloadThread.pas',
  GLE.Game in 'GLE.Game.pas',
  GLE.Resources in 'GLE.Resources.pas',
  GLE.About in 'GLE.About.pas' {Frm_About},
